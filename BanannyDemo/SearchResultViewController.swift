...
class SearchResultViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var searchResults:[searchResult] = [
        searchResult(nameResult: "王彩霞", imageResult: "nanny_profile_01", starResult: 4, numResult: "(24)", hourResult: "$200/hr", finishResult: "24", startDay: "2007/06/23", nannyId: "105xxxxx300", vacationRate: "$250/hr", specialRate: "$300/hr", specialText: "晚上十點後到早上七點", minimalHour: "3小時", specialExp: "我有帶過自閉症兒童，過動兒", nannyIntro: "親愛的爸爸媽媽你們好，我有過十年以上的托育經驗。我自己非常愛小孩子，家中有四個小孩，最大的已經高中。希望有機會合作！", startYear: "2007"),
        searchResult(nameResult: "吳情美", imageResult: "nanny_profile_02", starResult: 4.5, numResult: "(15)", hourResult: "$250/hr", finishResult: "15", startDay: "2005/01/23", nannyId: "105xxxxx200", vacationRate: "$300/hr", specialRate: "$300/hr", specialText: "晚上十點後到早上七點", minimalHour: "4小時", specialExp: "我有帶過自閉症兒童，過動兒", nannyIntro: "親愛的爸爸媽媽你們好，我有過十年以上的托育經驗。我自己非常愛小孩子，家中有四個小孩，最大的已經高中。希望有機會合作！", startYear: "2005"),
        searchResult(nameResult: "周麗美", imageResult: "nanny_profile_03", starResult: 5, numResult: "(35)", hourResult: "$250/hr", finishResult: "35", startDay: "1999/05/27",nannyId: "105xxxxx100", vacationRate: "$300/hr", specialRate: "$300/hr", specialText: "晚上十點後到早上七點", minimalHour: "6小時", specialExp: "我有帶過自閉症兒童，過動兒", nannyIntro: "親愛的爸爸媽媽你們好，我有過十年以上的托育經驗。我自己非常愛小孩子，家中有四個小孩，最大的已經高中。希望有機會合作！", startYear: "1999")
    ]
